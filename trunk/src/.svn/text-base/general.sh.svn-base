...
${HADOOP_CMD} jar $(dirname $(which hadoop))/../contrib/streaming/hadoop-0.19.1-streaming.jar \
           ...
           -jobconf mapred.job.name="sim rank - init" \
           -mapper './general_mapper' -file ${CUR_DIR}/general_mapper \
           -reducer './general_reducer' -file ${CUR_DIR}/general_reducer
