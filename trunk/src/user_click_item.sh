...
${HADOOP_CMD} jar $(dirname $(which hadoop))/../contrib/streaming/hadoop-0.19.1-streaming.jar \
           ...
           -mapper './user_click_item_mapper'  \
           -file ${CUR_DIR}/user_click_item_mapper $lib_extra_str \
           -jobconf mapred.reducer.tasks=300 -jobconf mapred.job.name="q-doc-click-info" \
           -reducer './user_click_item_reducer' \
           -file ${CUR_DIR}/user_click_item_reducer
