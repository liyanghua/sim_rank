...
INPUT1=${HPATH}/sim_rank_step4/$bizdate/
...
${HADOOP_CMD} jar $(dirname $(which hadoop))/../contrib/streaming/hadoop-0.19.1-streaming.jar \
           ...
           -jobconf mapred.job.name="sim rank - final step" \
           -mapper "sim_rank_step5_mapper" -file ${CUR_DIR}/sim_rank_step5_mapper \
           -jobconf file_flag="sim_rank_step4" \
           -reducer "sim_rank_step5_reducer" -file ${CUR_DIR}/sim_rank_step5_reducer \
